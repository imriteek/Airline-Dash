...
app.layout = html.Div(children=[ 
                                ...
                                html.H1('US Domestic Airline Flights Performance',
                                        style={'textAlign':'center','background-color':'#decddd' , 'font-size': 24}),
                                html.H4("Designed By :- Riteek Sharma", 
                                       style={'textAlign':'center', 'background-color':'#decddd', 'font-size': 20}),
                                ...
                                html.Div([
                                    ...
                                    html.Div([
                                        ...
                                        html.Div(
                                            [
                                            html.H4('Report Type:', style={'background-color':'#cedddd', 'margin-right':'2em', 'padding':'3px'}),
                                            ]
                                        ),
                                   ...
                                   html.Div([
                                       # Create an division for adding dropdown helper text for choosing year
                                        html.Div(
                                            [
                                            html.H4('Choose Year:', style={'background-color':'#cedddd', 'margin-right':'2em', 'padding':'3px'})
                                            ]
                                        ),
...
def get_graph(chart, year, c1, c2, c3, c4, c5):
        ...
        if chart == 'OPT1':
            ...
            bar_fig.update_layout(title_text='Monthly Flight Cancellation', title_x=0.5, template="ggplot2")
            ...
            line_fig.update_layout(title_text='Average monthly flight time (minutes) by airline', title_x=0.5, template="ggplot2")
            ...
            pie_fig.update_layout(title_text='% of flights by reporting airline', title_x=0.5)
            ...
            tree_fig.update_layout(
                    title_text = 'Flight count by airline to destination state', title_x=0.5)
            ...
            carrier_fig.update_layout(title_text='Average carrrier delay time (minutes) by airline', title_x=0.5, template="ggplot2")
            ...
            weather_fig.update_layout(title_text='Average weather delay time (minutes) by airline', title_x=0.5, template="ggplot2")
            ...
            nas_fig.update_layout(title_text='Average NAS delay time (minutes) by airline', title_x=0.5, template="ggplot2")
            ...
            sec_fig.update_layout(title_text='Average security delay time (minutes) by airline', title_x=0.5, template="ggplot2")
            ...
            late_fig.update_layout(title_text='Average late aircraft delay time (minutes) by airline', title_x=0.5, template="ggplot2")
